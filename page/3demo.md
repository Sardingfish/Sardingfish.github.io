...
<div style="display:flex; justify-content:center; gap:3.5%;">
  <div style="flex:0 0 31%; border:1px solid #e0e0e0; border-radius:8px; padding:20px; background:#ffffff; box-sizing:border-box;">
    <img src="https://raw.githubusercontent.com/Sardingfish/TropDS/master/web/asset/rmse_zhd.gif" width="100%"><br>
    <span style="color: #909090;">----------------</span><br>
